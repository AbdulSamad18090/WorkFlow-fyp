    ...
    return (
        <div style={{ position: 'relative', width: '120px', height: '60px' }}>
            <svg width="120" height="60">
                {/* Updated document shape with a more accurate wave curve */}
                <path 
                    d="M 2 2 H 118 V 40 Q 85 55, 60 48 Q 35 40, 2 48 Z" 
                    fill={color} 
                    stroke="black" 
                    strokeWidth="1" 
                />
            ...
            <Handle
                ...
                position="right"
                id="right1"
                style={{ right: '-1px', top: '15%', transform: 'translateY(-50%)', zIndex: 10 }}
                className="bg-gray-800 opacity-0 hover:opacity-100"
            />
            <Handle
                type="target"
                position="right"
                id="right2"
                style={{ right: '-1px', top: '60%', transform: 'translateY(-50%)', zIndex: 10 }}
                className="bg-gray-800 opacity-0 hover:opacity-100"
            />
            <Handle
                type="source"
                position="bottom"
                id="bottom1"
                style={{ bottom: '16px', left: '25%', transform: 'translateX(-50%)', zIndex: 10 }}
                className="bg-gray-800 opacity-0 hover:opacity-100"
            />
            <Handle
                type="target"
                position="bottom"
                id="bottom2"
                style={{ bottom: '11px', left: '75%', transform: 'translateX(-50%)', zIndex: 10 }}
                className="bg-gray-800 opacity-0 hover:opacity-100"
            />
            <Handle
                type="source"
                position="left"
                id="left1"
                style={{ left: '-1px', top: '15%', transform: 'translateY(-50%)', zIndex: 10 }}
                className="bg-gray-800 opacity-0 hover:opacity-100"
            />
            <Handle
                type="target"
                position="left"
                id="left2"
                style={{ left: '-1px', top: '60%', transform: 'translateY(-50%)', zIndex: 10 }}
                className="bg-gray-800 opacity-0 hover:opacity-100"
            />
        </div>
    );
