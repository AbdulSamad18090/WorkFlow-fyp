    ...
    <div className="w-72 bg-gray-200 shadow-lg p-6 flex flex-col h-full overflow-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center space-x-2 mb-4">
          {/* New Icon for Process Node Types */}
          <svg className="w-5 h-5 text-gray-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
            <rect x="3" y="3" width="18" height="18" stroke="currentColor" strokeWidth="2" />
          </svg>
          <h3 className="text-l font-bold text-gray-700">Process Node Types</h3>
        </div>
        ...
        <div className="flex flex-col space-y-4 mb-6">
          ...
          />
            ...
            Icon={() => (
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="4" y="4" width="16" height="18" stroke="black" strokeWidth="2" />
          ...
          />
           <DraggableButton
            ...
            Icon={() => (
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 2 L2 22 H22 Z" stroke="black" strokeWidth="2" fill="none" />
              </svg>
            )}
            onDragStart={handleDragStart}
          />
          ...
          />
            ...
            Icon={() => (
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4 4 L20 12 L4 20 Z" stroke="black" strokeWidth="2" />
              </svg>
            )}
            onDragStart={handleDragStart}
          />
      ...
      <div className="mb-8">
        <div className="flex items-center space-x-2 mb-4">
          {/* New Icon for Swimlane Section */}
          <svg className="w-5 h-5 text-gray-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
            <path strokeLinecap="round" strokeLinejoin="round" d="M3 7h18M3 12h18M3 17h18" />
          </svg>
          <h3 className="font-bold text-lg text-gray-700">Swimlane Nodes</h3>
        </div>
        <button
          className="bg-blue-500 text-white p-2 w-full rounded hover:bg-blue-700 flex items-center justify-center"
